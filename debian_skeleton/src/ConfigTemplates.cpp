...
namespace VenomTemplates {
    ...
    const std::vector<std::string> SYSCTL_BOOTSTRAP_CONTENT = {
        ...
        "kernel.printk=3 4 1 3", // Dmesg zajszűrés
    ...
    const std::vector<std::string> BLACKLIST_CONTENT = {
        ...
        "options iwlwifi power_save=0", // WiFi stabilitás
    ...
    const std::vector<std::string> FSTAB_HARDENING_CONTENT = {
        ...
        "tmpfs     /dev/shm     tmpfs     defaults,nodev,nosuid         0     0", // noexec NINCS
        "tmpfs     /run         tmpfs     defaults,nodev,nosuid         0     0", // noexec NINCS
